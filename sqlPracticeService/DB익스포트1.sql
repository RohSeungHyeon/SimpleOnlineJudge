...
SET DEFINE OFF;
Insert into C##ORA_USER.BBS (BBSID,BBSTITLE,USERID,BBSDATE,BBSCONTENT,BBSAVAILABLE) values (3,'안녕하세요!!!','123',to_date('20/07/21','RR/MM/DD'),'gkdl',1);
Insert into C##ORA_USER.BBS (BBSID,BBSTITLE,USERID,BBSDATE,BBSCONTENT,BBSAVAILABLE) values (2,'1111!','123',to_date('20/07/21','RR/MM/DD'),'1111',0);
Insert into C##ORA_USER.BBS (BBSID,BBSTITLE,USERID,BBSDATE,BBSCONTENT,BBSAVAILABLE) values (1,'333!!!!!!!','123',null,'3333',1);